        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul class="space-y-2">
              ...
              <li><NuxtLink to="/docs/faq" class="text-gray-600 hover:text-blue-600 text-sm">FAQ</NuxtLink></li>
              <li><NuxtLink to="/docs/api" class="text-gray-600 hover:text-blue-600 text-sm">API Documentation</NuxtLink></li>
